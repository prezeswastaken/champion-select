...
<body>
    <div class="bg-black text-white w-screen min-h-screen font-mono gap-5  flex flex-col pt-20 items-center">
        ...
        <a href="main"
            class="text-7xl uppercase m-10  border border-white p-5 rounded-xl border-transparent hover:border-orange-400 hover:text-orange-400 duration-300 hover:cursor-grab">start</a>
        <div class="flex border border-white rounded-xl px-5 py-2 w-1/3">
            <p>So, you want to start your journey with <a href="https://www.leagueoflegends.com/" target="_blank"
                ...
                sure which champion to pick? Well, there is some many of them! I know the feeling, i had the same back
